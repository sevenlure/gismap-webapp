...
import TableListContainer from 'src/containers/baocaogiamsatmoitruong/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.baocaogiamsatmoitruong.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.baocaogiamsatmoitruong.create}>
          <a style={{ fontSize: 20 }}>
