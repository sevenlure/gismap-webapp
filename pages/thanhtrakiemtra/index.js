...
import TableListContainer from 'src/containers/thanhtrakiemtra/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.thanhtrakiemtra.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.thanhtrakiemtra.create}>
          <a style={{ fontSize: 20 }}>
