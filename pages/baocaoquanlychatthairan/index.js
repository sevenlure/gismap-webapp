...
import TableListContainer from 'src/containers/baocaoquanlychatthairan/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.baocaoquanlychatthairan.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.baocaoquanlychatthairan.create}>
          <a style={{ fontSize: 20 }}>
