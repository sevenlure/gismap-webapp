...
import TableListContainer from 'src/containers/ttmoitruong/khaithacnuocmat/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.ttmoitruong.khaithacnuocmat.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.ttmoitruong.khaithacnuocmat.create}>
          <a style={{ fontSize: 20 }}>
