...
import TableListContainer from 'src/containers/ttmoitruong/sochunguonthai/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.ttmoitruong.sochunguonthai.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.ttmoitruong.sochunguonthai.create}>
          <a style={{ fontSize: 20 }}>
