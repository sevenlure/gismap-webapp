...
import TableListContainer from 'src/containers/ttmoitruong/htxulykhithai/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.ttmoitruong.htxulykhithai.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.ttmoitruong.htxulykhithai.create}>
          <a style={{ fontSize: 20 }}>
