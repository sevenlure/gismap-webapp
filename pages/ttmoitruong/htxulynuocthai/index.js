...
import TableListContainer from 'src/containers/ttmoitruong/htxulynuocthai/tableListContainer'
...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.props.setBreadCrumb(breadcrumb[slug.ttmoitruong.htxulynuocthai.list])
  }
  ...
  render() {
    return (
      <div>
        <Link href={slug.ttmoitruong.htxulynuocthai.create}>
          <a style={{ fontSize: 20 }}>
