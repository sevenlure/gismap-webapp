...
@connect(state => ({
  initialOptions: _get(state, 'GeneralStore.danhMuc.TinhTrangHoatDong', []),
  danhMucIsLoaded: _get(state, 'GeneralStore.danhMucIsLoaded', false)
}))
class SelectTinhTrangHoatDong extends React.PureComponent {
  static propTypes = {
...
export default SelectTinhTrangHoatDong
