...
@connect(state => ({
  initialOptions: _get(state, 'GeneralStore.danhMuc.TinhTrangKiemTra', []),
  danhMucIsLoaded: _get(state, 'GeneralStore.danhMucIsLoaded', false)
}))
class SelectTinhTrangKiemTra extends React.PureComponent {
  static propTypes = {
...
export default SelectTinhTrangKiemTra
