...
@connect(state => ({
  initialOptions: _get(state, 'GeneralStore.danhMuc.DacTrungNuocThai', []),
  danhMucIsLoaded: _get(state, 'GeneralStore.danhMucIsLoaded', false)
}))
class SelectDacTrungNuocThai extends React.PureComponent {
  static propTypes = {
...
export default SelectDacTrungNuocThai
