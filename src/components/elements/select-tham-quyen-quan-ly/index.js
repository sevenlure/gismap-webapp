...
@connect(state => ({
  initialOptions: _get(state, 'GeneralStore.danhMuc.CoQuanThamQuyenQuanLy', []),
  danhMucIsLoaded: _get(state, 'GeneralStore.danhMucIsLoaded', false)
}))
class SelectCoQuanThamQuyenQuanLy extends React.PureComponent {
  static propTypes = {
...
export default SelectCoQuanThamQuyenQuanLy
