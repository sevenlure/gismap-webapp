...
import { deleteById, getList } from 'src/api/thanhtrakiemtraApi'
...
class TableListContainer extends React.Component {
  ...
  columns = [
    {
      ...
      render: (text, record) => (
        <Link
          href={slug.thanhtrakiemtra.edit}
          as={`${slug.thanhtrakiemtra.base}/${get(record, 'ThanhTraKiemTra._id')}`}
        >
    ...
    {
      title: 'Số quyết định kiểm tra',
      dataIndex: 'ThanhTraKiemTra.SoQuyetDinhKiemTra',
      key: 'SoQuyetDinhKiemTra'
    },
    {
      title: 'Ngày kiểm tra',
      dataIndex: 'ThanhTraKiemTra.NgayKiemTra',
      key: 'NgayKiemTra',
      render: field => {
    ...
    {
      title: 'Tình trạng',
      dataIndex: 'ThanhTraKiemTra.TinhTrangKiemTra.Name',
      key: 'TinhTrangKiemTra'
    },

    {
      title: 'Cập nhật bởi',
      dataIndex: 'ThanhTraKiemTra.UpdatedBy',
      key: 'UpdatedBy'
    },
    {
      title: '',
      ...
      render: (text, record) => (
        <div style={{ display: 'flex', justifyContent: 'space-around' }}>
          <Popconfirm
            ...
            placement='left'
            onConfirm={() => {
              this.handleDelete(get(record, 'ThanhTraKiemTra._id'))
            }}
          >
  ...
  render() {
    return (
      <Table
        rowKey={record => {
          return record.ThanhTraKiemTra._id
        }}
        size='middle'
